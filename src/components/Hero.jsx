...
const Hero = ({ title = "Hi, Welcome to My Portfolio" }) => {
  ...
  return (
    <section className="bg-indigo-700 py-10 mb-4 flex flex-row md:rounded-3xl">
      ...
      <div className="max-w-7xl mx-5 px-4 sm:px-6 lg:px-8 flex flex-col items-center">
        <div className="text-center">
          <h1 className="text-4xl font-extrabold text-white sm:text-xl md:text-4xl">
            {title}
          </h1>
          ...
          <div>
            ...
            <button
              ...
              className="text-cyan-400 mb-5 hover:text-pink-600 text-2xl underline"
            >
              {showMore ? "Less Info" : "More Info"}
            </button>
          </div>

          <p className="text-white text-2xl sm:xl">
